...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Edit ProductAttribute', true), array('action'=>'edit', $productAttribute['ProductAttribute']['id'])); ?> </li>
		<li><?php echo $html->link(__('Delete ProductAttribute', true), array('action'=>'delete', $productAttribute['ProductAttribute']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $productAttribute['ProductAttribute']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($productAttribute['Product'])):?>
	...
	<?php
		$i = 0;
		foreach ($productAttribute['Product'] as $product):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
