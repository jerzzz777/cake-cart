...
?>
	<tr<?php echo $class;?>>
		...
		<td>
			<?php echo $html->link($productCategory['Image']['title'], array('controller'=> 'images', 'action'=>'view', $productCategory['Image']['id'])); ?>
		</td>
		<td>
		...
		<td>
			<?php echo $productCategory['ProductCategory']['sort_order']; ?>
		</td>
		<td>
